...
!(function webpackMissingModule() { var e = new Error("Cannot find module '../js/services/requests'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(x, y, z) {
      x.querySelector('.plus').addEventListener('click', function () {
        if (y !== z.length - 2) {
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function render() {
      ...
      var popup = setInterval(appear, 3000);

      function appear() {
        document.querySelector('.hanson').style.display = 'block';
        document.querySelector('.hanson').style.position = 'absolute';
      }
    }
  }]);
